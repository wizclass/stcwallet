...
span.btn {display:inline-block;*display:inline;*zoom:1;padding:0 10px;height:24px;line-height:24px;background-color:rgba(76,100,127,1);vertical-align:middle;color:#fff;cursor:pointer;}
				...
				<input type="text" value=<?=$member['mb_id']?> name="set_id_sel" id="set_id_sel" class="frm_input" placeholder="please input your username(ID)" /> <span id="ajax_id_search" class="btn">search</span> <span id="insert_id" class="btn" style="display:none;"> 해당 아이디 정보 입력</span>
    ...
    <section id="sod_frm_pay">
        ...
        <div class="tbl_frm01 tbl_wrap">
            ...
            <tr>
                ...
                <td><span id="od_tot_price"><?php echo number_format($tot_price); ?></span>USD($)</td>
            </tr>
            <!--tr>
                <th>추가배송비</th>
