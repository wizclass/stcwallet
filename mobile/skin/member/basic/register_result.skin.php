...
<style type="text/css">
.mbskin {}
.mbskin strong {color:rgba(230,0,68,1);}
</style>
<div id="reg_result" class="mbskin">

    <p>
        Congratulations  <strong><?php echo get_text($mb['mb_name']); ?></strong>, You just signed up in FIJI Mining.net<br>
    </p>

	<?
	/*##  ################################################*/
	?>
    <p>Your username is <strong><?=$mb['mb_id']?></strong>. Remember your username at all time. </p>
