...
?>
<style type="text/css">
.page_categorys {padding:10px;border-bottom:solid 2px #aeaeae;}
...
.page_categorys li a {padding:0 10px;display:block;line-height:22px;color:#505050;font-size:12px;font-family:"nngdb";word-break:keep-all;}
