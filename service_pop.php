...
.title p span{}
.btn_ly{width:100%;text-align:center;}
.btn_ly .btn{padding:3px 20px;background:#304a8a;color:white;}
</style>
...
<br>
	<div style="text-align:center;margin:0 auto;">
		<img src="<?=G5_THEME_URL?>/img/logo.png" width="30%" >
	</div>
<hr>
...
<div class="title" style="display:table;width:100%;height:200px;">
    ...
    <div class='btn_ly'><button type='button' class='btn back' onclick=' history.back(-1);' >back</button></div> 
