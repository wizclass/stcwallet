...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02">Wrtie</a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
    <!-- } 게시판 페이지 정보 및 버튼 끝 -->
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_adm">
            ...
            <li><input type="submit" name="btn_submit" value="hide" onclick="document.pressed=this.value"></li>
        </ul>
        <?php } ?>
...
<fieldset id="bo_sch">
    ...
    <select name="sfl" id="sfl">
        ...
        <!-- <option value="mb_id,0"<?php echo get_selected($sfl, 'mb_id,0'); ?>>id(코)</option> -->
...
function fboardlist_submit(f) {
    ...
    if (!chk_count) {
        alert(document.pressed + "할 게시물을 하나 이상 선택하세요vv");
        return false;
    }
