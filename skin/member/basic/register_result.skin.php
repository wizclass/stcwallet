...
<div id="reg_result" class="mbskin">
    ...
    <p>
        Congratulations  <strong><?php echo get_text($mb['mb_name'])." ".get_text($mb['mb_nick']); ?></strong>, You just signed up in PinnacleMining.net<br>
    </p>
    ...
    <div class="btn_confirm">
        <a href="<?php echo G5_URL ?>/" class="btn02">Go to Main</a>
    </div>
