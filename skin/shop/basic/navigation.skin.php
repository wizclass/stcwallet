...
?>
<style type="text/css">
.shop_path {height:74px;line-height:74px;font-family:"nngdb";font-size:12px;color:#666;}
.shop_path i {font-size:20px;vertical-align:-3px;color:#666;margin:0 5px;}
.shop_path select {border:solid 1px #ccc;padding:9px;color:#666;}
.shop_pageTitle {height:60px;line-height:60px;text-align:center;margin-bottom:20px;}
.shop_pageTitle h2 {font-weight:normal;font-size:40px;color:#222;font-family:"nngdb";}
</style>
<script>
$(function(){
