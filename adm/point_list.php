...
<div class="local_ov01 local_ov">
    ...
    if (isset($mb['mb_id']) && $mb['mb_id']) {
        echo '&nbsp;(' . $mb['mb_id'] .' 님 PV 합계 : ' . number_format($mb['mb_point']) . '점)';
    } else {
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        <th scope="col">
            <label for="chkall" class="sound_only">PV 내역 전체</label>
            <input type="checkbox" name="chkall" value="1" id="chkall" onclick="check_all(this.form)">
        </th>
        <th scope="col"><?php echo subject_sort_link('mb_id') ?>회원아이디</a></th>
        <th scope="col">이름</th>
        <th scope="col">닉네임</th>
        <th scope="col"><?php echo subject_sort_link('po_content') ?>PV 내용</a></th>
        <th scope="col"><?php echo subject_sort_link('po_point') ?>PV</a></th>
...
<section id="point_mng">
    <h2 class="h2_frm">개별회원 PV 증감 설정</h2>
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="po_content">PV 내용<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="po_content" id="po_content" required class="required frm_input" size="80"></td>
        </tr>
        <tr>
            <th scope="row"><label for="po_point">PV<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="po_point" id="po_point" required class="required frm_input"></td>
        </tr>
        <?php if($config['cf_point_term'] > 0) { ?>
        <tr>
            <th scope="row"><label for="po_expire_term">PV 유효기간</label></th>
