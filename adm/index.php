...
<section>
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        ?>
        <tr>
            <td class="td_num"><?php echo $mb_level ?></td>
            <td class="td_mbid"><?php echo $mb_id ?></td>
            <td class="td_category"><?php echo get_text($row['mb_name']); ?></td>
            <td class="td_category"><?php echo $row['mb_email'] ?></td>
            <td class="td_category"><?php echo $row['mb_hp'] ?></td>
        </tr>
        <?php
            }
        if ($i == 0)
