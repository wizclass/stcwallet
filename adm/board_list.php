...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col">읽기P<span class="sound_only">PV</span></th>
        <th scope="col">쓰기P<span class="sound_only">PV</span></th>
        <th scope="col">댓글P<span class="sound_only">PV</span></th>
        <th scope="col">다운P<span class="sound_only">PV</span></th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_numsmall">
            <label for="bo_read_point_<?php echo $i; ?>" class="sound_only">읽기 PV</label>
        ...
        <td class="td_numsmall">
            <label for="bo_write_point_<?php echo $i; ?>" class="sound_only">쓰기 PV</label>
        ...
        <td class="td_numsmall">
            <label for="bo_comment_point_<?php echo $i; ?>" class="sound_only">댓글 PV</label>
        ...
        <td class="td_numsmall">
            <label for="bo_download_point_<?php echo $i; ?>" class="sound_only">다운 PV</label>
