...
$pg_anchor = '<ul class="anchor">
    ...
    <li><a href="#anc_bo_point">PV 설정</a></li>
...
<section id="anc_bo_auth">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                <?php echo get_member_level_select('bo_write_level', 0, 10, $board['bo_write_level']) ?>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                <?php echo get_member_level_select('bo_reply_level', 0, 10, $board['bo_reply_level']) ?>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                <?php echo get_member_level_select('bo_comment_level', 0, 10, $board['bo_comment_level']) ?>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                <?php echo get_member_level_select('bo_link_level', 0, 10, $board['bo_link_level']) ?>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                <?php echo get_member_level_select('bo_upload_level', 0, 10, $board['bo_upload_level']) ?>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                <?php echo get_member_level_select('bo_download_level', 0, 10, $board['bo_download_level']) ?>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                <?php echo get_member_level_select('bo_html_level', 0, 10, $board['bo_html_level']) ?>
            </td>
            <td class="td_grpset">
...
<section id="anc_bo_point">
    <h2 class="h2_frm">게시판 PV 설정</h2>
    <?php echo $pg_anchor ?>

    <div class="tbl_frm01 tbl_wrap">
        <table>
        <caption>게시판 PV 설정</caption>
        <colgroup>
            <col class="grid_4">
            <col>
            <col class="grid_3">
        ...
        <tr>
            ...
            <td colspan="2">
                <?php echo help('환경설정에 입력된 PV로 설정') ?>
                <input type="checkbox" name="chk_grp_point" id="chk_grp_point" onclick="set_point(this.form)">
            </td>
        </tr>
        <tr>
            <th scope="row"><label for="bo_read_point">글읽기 PV<strong class="sound_only">필수</strong></label></th>
            <td>
        ...
        <tr>
            <th scope="row"><label for="bo_write_point">글쓰기 PV<strong class="sound_only">필수</strong></label></th>
            <td>
        ...
        <tr>
            <th scope="row"><label for="bo_comment_point">댓글쓰기 PV<strong class="sound_only">필수</strong></label></th>
            <td>
        ...
        <tr>
            <th scope="row"><label for="bo_download_point">다운로드 PV<strong class="sound_only">필수</strong></label></th>
            <td>
