    ...
    <table id='table'>
      ...
      <thead>
        <tr>
          ...
          <th scope="col" rowspan="2" id="mb_list_member" class="td_leave_date"><?php echo subject_sort_link('mb_name') ?>탈퇴일</a></th>
      ...
      <tbody>
        ...
        ?>
          ...
          <tr class="<?php echo $bg; ?>">
            ...
            <th scope="col" rowspan="2" class="td_mbstat" style='letter-spacing:0;'><?= $row['mb_leave_date'] ?></th>
