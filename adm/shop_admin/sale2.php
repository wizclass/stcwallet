...
<div class="local_sch02 local_sch">
    ...
    <div>
        <form name="frm_sale_today" action="./sale2today.php" method="get">
        <strong>일일 매출</strong>
    ...
    <div>
        <form name="frm_sale_date" action="./sale2date.php" method="get">
        <strong>일간 매출</strong>
    ...
    <div>
        <form name="frm_sale_month" action="./sale2month.php" method="get">
        <strong>월간 매출</strong>
    ...
    <div class="sch_last">
        <form name="frm_sale_year" action="./sale2year.php" method="get">
        <strong>연간 매출</strong>
