...
<form class="local_sch02 local_sch">
    <div class="sch_last">
        <input type="button" class="btn_submit excel" id="btnExport"  data-name='staking_saletoday' value="엑셀 다운로드" />
    </div>
</form>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col">상품명</th>
        <th scope="col"><a href="?ord=<?php echo $ord_rev; ?>&ord_word=orderprice&date=<?echo $date;?>">합계 (<?=ASSETS_CURENCY?>) <?php echo $ord_arrow[$ord_key]; ?></a></th>
        <th scope="col"><a href="?ord=<?php echo $ord_rev; ?>&ord_word=od_tax_flag&date=<?echo $date;?>">수수료 (<?=ASSETS_CURENCY?>)<?php echo $ord_arrow[$ord_key]; ?></a></th>
        <th scope="col"><a href="?ord=<?php echo $ord_rev; ?>&ord_word=od_cart_price&date=<?echo $date;?>">실 스테이킹 수량 (<?=ASSETS_CURENCY?>)<?php echo $ord_arrow[$ord_key]; ?></a></th>
        <!-- <th scope="col"><a href="?ord=<?php echo $ord_rev; ?>&ord_word=od_cash&date=<?echo $date;?>">현금가 (<?=BALANCE_CURENCY?>)<?php echo $ord_arrow[$ord_key]; ?></a></th> -->

		<th scope="col"><a href="?ord=<?php echo $ord_rev; ?>&ord_word=upstair&date=<?echo $date;?>">총지급예정 (<?=ASSETS_CURENCY?>)<?php echo $ord_arrow[$ord_key]; ?></a></th>
		<th scope="col"><a href="?ord=<?php echo $ord_rev; ?>&ord_word=pv&date=<?echo $date;?>">1회지급량 (<?=ASSETS_CURENCY?>)<?php echo $ord_arrow[$ord_key]; ?></a></th>
        <th scope="col">지급상태</th>
		<th scope="col"><a href="?ord=<?php echo $ord_rev; ?>&ord_word=od_invoice_time&date=<?echo $date;?>">만료일<?php echo $ord_arrow[$ord_key]; ?></a></th>
    </tr>
    </thead>
    <tbody>
    <?php
