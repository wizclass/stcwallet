    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                ...
                <label for="it_type1"><?=$adver[0]?><!-- //  <img src="<?php echo G5_SHOP_URL; ?>/img/icon_hit.gif" alt=""> // --></label>
                ...
                <label for="it_type2"><?=$adver[1]?><!-- // <img src="<?php echo G5_SHOP_URL; ?>/img/icon_rec.gif" alt=""> // --></label>
				<img src="/adm/img/space.png" width="20" height="1" />
                <input type="checkbox" name="it_type3" value="1" <?php echo ($it['it_type3'] ? "checked" : ""); ?> id="it_type3">
                <label for="it_type3"><?=$adver[2]?><!-- //  <img src="<?php echo G5_SHOP_URL; ?>/img/icon_new.gif" alt=""> // --></label>
				<img src="/adm/img/space.png" width="20" height="1" />
                <input type="checkbox" name="it_type4" value="1" <?php echo ($it['it_type4'] ? "checked" : ""); ?> id="it_type4">
                <label for="it_type4"><?=$adver[3]?><!-- //  <img src="<?php echo G5_SHOP_URL; ?>/img/icon_best.gif" alt=""> // --></label>
				<img src="/adm/img/space.png" width="20" height="1" />
                <input type="checkbox" name="it_type5" value="1" <?php echo ($it['it_type5'] ? "checked" : ""); ?> id="it_type5">
                <label for="it_type5"><?=$adver[4]?><!-- //  <img src="<?php echo G5_SHOP_URL; ?>/img/icon_discount.gif" alt=""> // --></label>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            <th scope="row"><label for="it_model">단위</label></th>
            <td>
                <?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
...
<section id="anc_sitfrm_cost">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="it_point_type">PV 유형</label></th>
            <td>
                <?php echo help("PV 유형을 설정할 수 있습니다. 비율로 설정했을 경우 설정 기준금액의 %비율로 PV가 지급됩니다."); ?>
        ...
        <tr>
            ...
            <td>
                <?php echo help("주문완료후 환경설정에서 설정한 주문완료 설정일 후 회원에게 부여하는 PV입니다.\n또, PV부여를 '아니오'로 설정한 경우 신용카드, 계좌이체로 주문하는 회원께는 부여하지 않습니다."); ?>
		...
		?>
        <tr>
            <th scope="row"><label for="it_bv">BV</label></th>
            <td>
                <input type="text" name="it_bv" value="<?php echo $it['it_bv']; ?>" id="it_bv" class="frm_input" size="8"> <span id="it_bv_unit"><?php if($it['it_bv_type']) echo '%'; else echo '점'; ?></span>
            </td>
            <td class="td_grpset">
                <input type="checkbox" name="chk_ca_it_bv" value="1" id="chk_ca_it_bv">
                <label for="chk_ca_it_bv">분류적용</label>
                <input type="checkbox" name="chk_all_it_bv" value="1" id="chk_all_it_bv">
                <label for="chk_all_it_bv">전체적용</label>
            </td>
        </tr>		
		<?
		/*@@End. BV #####*/
        ...
        <tr>
            <th scope="row"><label for="it_supply_point">추가옵션상품 PV</label></th>
            <td>
                <?php echo help("상품의 추가옵션상품 구매에 일괄적으로 지급하는 PV입니다. 0으로 설정하시면 구매PV를 지급하지 않습니다.\n주문완료후 환경설정에서 설정한 주문완료 설정일 후 회원에게 부여하는 PV입니다.\n또, PV부여를 '아니오'로 설정한 경우 신용카드, 계좌이체로 주문하는 회원께는 부여하지 않습니다."); ?>
...
$(function() {
    $(".sit_wimg_view").bind("click", function() {
        ...
        if($img_display.is(":visible")) {
            $(this).text($(this).text().replace("확인", "close"));
        } else {
            $(this).text($(this).text().replace("close", "확인"));
        }
    ...
    $(".sit_wimg_close").bind("click", function() {
        ...
        $button.text($button.text().replace("close", "확인"));
    });
});
<?php } ?>
...
function fitemformcheck(f)
{
    ...
    if(f.it_point_type.value == "1") {
        ...
        if(point > 99) {
            alert("PV 비율을 0과 99 사이의 값으로 입력해 주십시오.");
            return false;
        }
    }
	/* ################################ */
    if(f.it_bv_type.value == "1") {
        var bv = parseInt(f.it_bv.value);
        if(bv > 99) {
            alert("BV 비율을 0과 99 사이의 값으로 입력해 주십시오.");
            return false;
        }
    }
