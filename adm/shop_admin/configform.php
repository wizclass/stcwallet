...
<section id ="anc_scf_payment">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="cf_use_point">PV 사용</label></th>
            <td>
        ...
        <tr>
            <th scope="row"><label for="de_settle_min_point">결제 최소PV</label></th>
            <td>
                <?php echo help("회원의 PV가 설정값 이상일 경우만 주문시 결제에 사용할 수 있습니다.\nPV 사용을 하지 않는 경우에는 의미가 없습니다."); ?>
        ...
        <tr>
            <th scope="row"><label for="de_settle_max_point">최대 결제PV</label></th>
            <td>
                <?php echo help("주문 결제시 최대로 사용할 수 있는 PV를 설정합니다.\nPV 사용을 하지 않는 경우에는 의미가 없습니다."); ?>
        ...
        <tr>
            <th scope="row"><label for="de_settle_point_unit">결제 PV단위</label></th>
            <td>
                <?php echo help("주문 결제시 사용되는 PV의 절사 단위를 설정합니다."); ?>
        ...
        <tr>
            <th scope="row"><label for="de_card_point">PV부여</label></th>
            <td>
                <?php echo help("신용카드, 계좌이체, 휴대폰 결제시 PV를 부여할지를 설정합니다. (기본값은 '아니오')"); ?>
        ...
        <tr>
            <th scope="row"><label for="de_point_days">주문완료 PV</label></th>
            <td>
                <?php echo help("주문자가 회원일 경우에만 주문완료시 PV를 지급합니다. 주문취소, 반품 등을 고려하여 PV를 지급할 적당한 기간을 입력하십시오. (기본값은 7일)\n0일로 설정하는 경우에는 주문완료와 동시에 PV를 지급합니다."); ?>
                주문 완료 <input type="text" name="de_point_days" value="<?php echo $default['de_point_days']; ?>" id="de_point_days" class="frm_input" size="2"> 일 이후에 PV를 지급
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <select id="de_pg_service" name="de_pg_service">
                    <option value="billgate" <?php echo get_selected($default['de_pg_service'], 'billgate'); ?>>빌게이트</option>
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                ...
                <?php echo get_member_level_select('de_level_sell', 0, 10, $default['de_level_sell']); ?>
            </td>
        </tr>
        <tr>
