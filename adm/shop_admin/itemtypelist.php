...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col"><?php echo subject_sort_link("it_type1", $qstr, 1); ?><?=str_replace(" ","<br/>",$adver[0])?></a></th>
        <th scope="col"><?php echo subject_sort_link("it_type2", $qstr, 1); ?><?=str_replace(" ","<br/>",$adver[1])?></a></th>
        <th scope="col"><?php echo subject_sort_link("it_type3", $qstr, 1); ?><?=str_replace(" ","<br/>",$adver[2])?></a></th>
        <th scope="col"><?php echo subject_sort_link("it_type4", $qstr, 1); ?><?=str_replace(" ","<br/>",$adver[3])?></a></th>
        <th scope="col"><?php echo subject_sort_link("it_type5", $qstr, 1); ?><?=str_replace(" ","<br/>",$adver[4])?></a></th>
        <th scope="col">관리</th>
    </tr>
    </thead>
    <tbody>
