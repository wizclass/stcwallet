...
<div class="tbl_head02 tbl_wrap">
    ...
    <tr>
        ...
        <!-- <th scope="col" id="th_pc_title" style='width:100px;'><?php echo subject_sort_link('it_name', 'sca='.$sca); ?>지급상품명</a></th> -->
        <th scope="col" id="th_pc_title" style='width:100px;'><?php echo subject_sort_link('it_option_subject', 'sca='.$sca); ?>노출상품명</a></th>
        ...
        <th scope="col" id="th_pt" style='width:100px;'><?php echo subject_sort_link('it_point', 'sca='.$sca); ?>스테이킹 기간 (년 단위)</a></th>
        <th scope="col" id="th_pt" style='width:100px;'><?php echo subject_sort_link('it_supply_point', 'sca='.$sca); ?>스테이킹 수익 (% 단위)</a></th>
        <th scope="col" id="th_pt" style='width:100px;'><?php echo subject_sort_link('it_price', 'sca='.$sca); ?>스테이킹 최소 수량</a></th>
        <th scope="col" id="th_pt" style='width:100px;'><?php echo subject_sort_link('it_cust_price', 'sca='.$sca); ?>스테이킹 수수료 (% 단위)</a></th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="th_pt" class="td_numbig td_input" id="it_point">
            <label for="it_point" class="sound_only"></label>
            <input type="text" name="it_point[<?php echo $i; ?>]" value="<?=$row['it_point'] ?>" id="point_<?php echo $i; ?>" class="frm_input sit_amt" size="5" style="width:100px;padding-right:5px;background:#f4ffe8 !important" inputmode = "numeric">
        </td>
        

        <td headers="th_amt" class="td_numbig td_input">
            <label for="price_<?php echo $i; ?>" class="sound_only"></label>
            <input type="text" name="it_supply_point[<?php echo $i; ?>]" value="<?=$row['it_supply_point']; ?>" id="supply_<?php echo $i; ?>" class="frm_input sit_amt" size="5" style="width:100px;padding-right:5px;background:#f8e8ff !important"> %
        </td>

        <td headers="th_amt" class="td_numbig td_input">
            <label for="price_<?php echo $i; ?>" class="sound_only"></label>
            <input type="text" name="it_price[<?php echo $i; ?>]" value="<?=$row['it_price']; ?>" class="frm_input sit_amt" size="5" style="width:100px;padding-right:5px;background:#f4ffe8 !important">
        </td>

        <td headers="th_amt" class="td_numbig td_input">
            <label for="price_<?php echo $i; ?>" class="sound_only"></label>
            <input type="text" name="it_cust_price[<?php echo $i; ?>]" value="<?=$row['it_cust_price']; ?>"  class="frm_input sit_amt" size="5" style="width:100px;padding-right:5px;background:#f8e8ff !important"> %
        </td>
