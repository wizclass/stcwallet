...
$sql = " select *
		from {$g5['giftcard_history_table']}
		where SUBSTRING(insert_date,1,10) = '$date'
            ";
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col">상품명</th>
        <th scope="col"><a href="?ord=<?php echo $ord_rev; ?>&ord_word=price_coin&date=<?echo $date;?>">합계 (<?=ASSETS_CURENCY?>) <?php echo $ord_arrow[$ord_key]; ?></a></th>
        <th scope="col"><a href="?ord=<?php echo $ord_rev; ?>&ord_word=price_coin_fee&date=<?echo $date;?>">수수료 (<?=ASSETS_CURENCY?>)<?php echo $ord_arrow[$ord_key]; ?></a></th>
        <th scope="col"><a href="?ord=<?php echo $ord_rev; ?>&ord_word=origin_price_coin&date=<?echo $date;?>">실 사용 수량 (<?=ASSETS_CURENCY?>)<?php echo $ord_arrow[$ord_key]; ?></a></th>

		<th scope="col">쿠폰번호</th>
		<th scope="col">유효기간 (일)</th>
		<th scope="col"><a href="?ord=<?php echo $ord_rev; ?>&ord_word=expiry_date&date=<?echo $date;?>">만료일<?php echo $ord_arrow[$ord_key]; ?></a></th>
