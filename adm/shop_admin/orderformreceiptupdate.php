...
/*##  ################################################*/
$mod_history .= G5_TIME_YMDHIS.' '.$member['mb_id'].' 현금:'.number_format($_POST["od_receipt_cash"]).'/매장카드:'.number_format($_POST["od_receipt_price"]).' 변경처리'.$pg_cancel_log."\n";
/*@@End.  #####*/
...
$od_misu = ( $od['od_cart_price'] - $od['od_cancel_price'] + $_POST['od_send_cost'] + $_POST['od_send_cost2'] )
           ...
           - ( $_POST['od_receipt_price'] + $_POST['od_receipt_point'] + $_POST['od_receipt_cash'] - $_POST['od_refund_price'] );
