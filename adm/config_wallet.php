...
<form name="fsearch" id="fsearch" class="local_sch01 local_sch" action="../wallet_send.php" method="POST">
	
	<input type="text" name="to" placeholder="송금할 지갑 주소" class="frm_input" value="" style="width:600px;"/>

    <input type="text" name="value" id="value" placeholder="송금액" class="frm_input" value="" />
    
    <input type="text" name="passphrase" id="passphrase" placeholder="패스워드" class="frm_input" value="" />
    
	<input type="submit" class="btn_submit" value="보내기" />
</form>
<br><br>
