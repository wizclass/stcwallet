...
<form name="frmnewwin" action="./admin.sub.switch.proc.php" onsubmit="return frmnewwin_check(this);" method="post">
	...
	<div class="tbl_frm01 tbl_wrap">
		...
		<td>
            <p style="padding:0;"><input type="checkbox" id="nw_change" name="nw_change" <? if ($nw['nw_change'] == 'Y') {
																																														echo "checked";
																																													} ?>/><label for="nw_change" style=""><span class="ui"></span><span class="nw_change_txt">사용 설정</span></label></p>
		</td>
		...
		<td>
 		...
 		-->
					...
					<td>
						<p style="padding:0;"><input type="checkbox" id="nw_with" name="nw_with" <? if ($nw['nw_with'] == 'Y') {
																																												echo "checked";
																																											} ?> /><label for="nw_with" style=""><span class="ui"></span><span class="nw_with_txt">사용 설정</span></label></p>
					</td>
				</tr>

				<tr>
					<th scope="row"><label for="nw_upstair">스테이킹<strong class="sound_only"> 필수</strong></label></th>
					<td>
						<p style="padding:0;"><input type="checkbox" id="nw_upstair" name="nw_upstair" <? if ($nw['nw_upstair'] == 'Y') {
																																															echo "checked";
																																														} ?> /><label for="nw_upstair" style=""><span class="ui"></span><span class="nw_upstair_txt">사용 설정</span></label></p>
					</td>
		...
		<td>
            <p style="padding:0;"><input type="checkbox" id="nw_change" name="nw_change" <? if ($nw['nw_change'] == 'Y') {
				...
				<tr>
					...
					<td>
						<p style="padding:0;"><input type="checkbox" id="nw_enroll" name="nw_enroll" <? if ($nw['nw_enroll'] == 'Y') {
																																														echo "checked";
																																													} ?> /><label for="nw_enroll" style=""><span class="ui"></span><span class="nw_enroll_txt">사용 설정</span></label></p>
					</td>
				</tr>
