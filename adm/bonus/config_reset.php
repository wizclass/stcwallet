	...
	<div class="tbl_frm01 tbl_wrap">
		<table>
			...
			<tbody>
				...
				<tr>
					<th scope="row"><label for="nw_member_reset"> 회원포인트 초기화<strong class="sound_only"> 필수</strong></label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="nw_mining_reset"> 스테이킹 내역 초기화<strong class="sound_only"> 필수</strong></label></th>
					<td>
					...
					<th scope="row"><label for="nw_data_test"> 테스트 스테이킹 상품 구매 <strong class="sound_only"> 필수</strong></label></th>
					<td>
