...
<section id="anc_cf_basic">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="cf_login_point">로그인시 PV<strong class="sound_only">필수</strong></label></th>
            <td>
            ...
            <th scope="row"><label for="cf_memo_send_point">쪽지보낼시 차감 PV<strong class="sound_only">필수</strong></label></th>
            <td>
                 <?php echo help('양수로 입력하십시오. 0점은 쪽지 보낼시 PV를 차감하지 않습니다.') ?>
        ...
        <tr>
            <th scope="row"><label for="cf_point_term">PV 유효기간</label></th>
            <td colspan="3">
                <?php echo help('기간을 0으로 설정시 PV 유효기간이 적용되지 않습니다.') ?>
...
<section id="anc_cf_board">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="cf_read_point">글읽기 PV<strong class="sound_only">필수</strong></label></th>
            ...
            <th scope="row"><label for="cf_write_point">글쓰기 PV</label></th>
        ...
        <tr>
            <th scope="row"><label for="cf_comment_point">댓글쓰기 PV</label></th>
            ...
            <th scope="row"><label for="cf_download_point">다운로드 PV</label></th>
...
<section id="anc_cf_join">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td><?php echo get_member_level_select('cf_register_level', 0, 9, $config['cf_register_level']) ?></td>
            <th scope="row"><label for="cf_register_point">회원가입시 PV</label></th>
        ...
        <tr>
            ...
            <td><?php echo get_member_level_select('cf_icon_level', 0, 9, $config['cf_icon_level']) ?> 이상</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <th scope="row"><label for="cf_recommend_point">추천인 PV</label></th>
