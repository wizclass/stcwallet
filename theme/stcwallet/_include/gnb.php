...
<section id="wrapper" class="<? if ($menubar) {
																echo "menu_back_gnb";
															} ?>">
	<header>
		<? if ($menubar) { ?>
		...
		<? if (!$menubar) { ?>
			<nav class="left_gnbWrap">
				...
				<ul class="left_gnb">
					<li class="dashboard_icon <? if ($_SERVER['REQUEST_URI'] === '/') {
																			echo 'active';
																		} ?>">
						<a href="/">
					...
					<li class="profile_icon <? if ($_GET['id'] === 'profile') {
																		echo 'active';
																	} ?>">
					...
					<? if ($nw['nw_with'] == 'Y') { ?>
						<li class="mywallet_icon <? if ($_GET['id'] === 'mywallet') {
																				echo 'active';
																			} ?>">
					...
					<?php if ($nw['nw_upstair'] == 'Y') { ?>
						<?php if ($member['mb_level'] != 0) { ?>
							<li class="staking_icon <? if ($_GET['id'] === 'staking') {
																				echo 'active';
																			} ?>">
						...
						<? } ?>
					<?php } ?>
					<!-- 					<li class="giftcard_icon <? if ($_GET['id'] === 'giftcard_purchase') {
																										echo 'active';
																									} ?>">
					...
					<li class="notice_icon <? if ($_GET['id'] === 'news') {
																		echo 'active';
																	} ?>">
					...
					<li class="question_icon <? if ($_GET['id'] === 'support_center') {
																			echo 'active';
																		} ?>">
