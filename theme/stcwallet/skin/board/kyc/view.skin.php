...
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header>
        <h2 id="bo_v_title">
            ...
            ?>
			 <a href="/adm/member_form.php?sst=&sod=&sfl=&stx=&page=&w=u&mb_id=<?=$view['mb_id']?>" target="_blank" style="display:inline-block; font-size:20px;"> | <i class="fas fa-user-circle"></i> 회원정보</a>
			</span>
