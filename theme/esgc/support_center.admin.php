...
<main>
	<section class="con90_wrap support_center_admin">
		<div class="main-container dash_contents">
			<div id="body-wrapper">
				<div class="support-container">
					<div class="support-panels">
						<ul class="support-tabs">
							<li rel="active-tickets" data-i18n='support.활성화 티켓'><span>활성화 티켓</span></li>
							<li rel="answered-tickets" data-i18n='support.답변 티켓'><span>답변 티켓</span></li>
							<li rel="closed-tickets" data-i18n='support.비활성화 티켓'><span>비활성화 티켓</span></li>
						</ul>
...
<script>
	...
	if(url.indexOf('support_center.admin') != -1) {
