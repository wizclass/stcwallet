...
$(function() {
   ...
   /*  if( document.form_auth.up_hash.value != $opener.$("input[name=veri_up_hash]").val() ) {
    ...
    $opener.$("input[name=mb_name]").val("<?php echo $user_name; ?>").attr("readonly", true).css("display","block");
    $opener.$("input[name=mb_hp]").val("<?php echo $phone_no; ?>").attr("readonly", true).css("display","block");
