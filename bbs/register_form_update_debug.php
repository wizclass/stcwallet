...
/*디버그코드*/
$_POST['mb_id']= 'arcthan2';
$_POST['mb_password']= '!@zx235689';
$_POST['mb_password_re']= '!@zx235689';
$_POST['mb_email']= 'arcthan@gmail.com';
$_POST['nation_number']= '82';
$_POST['mb_hp']= '01097885852';
$_POST['mb_recommend']= 'new2';
$_POST['reg_tr_password']= '!@#zx235689';
$_POST['reg_tr_password_re']= '!@#zx235689';
...
*/		
			...
			if (strtolower($mb_id) == strtolower($mb_brecommend)) {
				alert('본인을 후원할 수 없습니다.');
			}
		}
	} else {
...
if ($w == '') {
	...
	echo "<script>
		...
		$('.pop_close').click(function() {
			document.location.href= '/bbs/register_form.php';
		});
