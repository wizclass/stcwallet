...
<p class="rg_em_p">If you did not receive email verification code, you can register a new email address</p>
...
<div class="tbl_frm01 tbl_frm rg_em">
    <table>
       <tr>
        <th scope="row"><label for="reg_mb_email">E-mail<strong class="sound_only">Essential</strong></label></th>
    ...
    <tr>
        <th scope="row">Auto enrollment prevention</th>
