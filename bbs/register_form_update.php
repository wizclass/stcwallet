...
if ($w == '') {
	...
	if ($foreign_row) {
		$foreign_update = "UPDATE {$g5['foreign_member_info']} SET mb_registertime = '" . G5_TIME_YMDHIS . "' WHERE mb_id = '{$foreign_row['mb_id']}'";
		sql_query($foreign_update);
	}
