    ...
    <section id="sod_frm_pay">
        ...
        <div class="tbl_frm01 tbl_wrap">
            ...
            <tr>
                ...
                <td><span id="od_cp_price">0</span>USD($)</td>
            </tr>
            <?php } ?>
            <?php if($sc_cnt > 0) { ?>
            <tr>
            ...
            <tr>
                ...
                <td><span id="sc_cp_price">0</span>USD($)</td>
            </tr>
            <?php } ?>
            <tr>
                <th>총 주문금액</th>
...
function forderform_check(f)
{
    ...
    <?php }  else if($default['de_pg_service'] == 'billgate') { ?>
    switch(settle_method)
    {
        case "계좌이체":
            f.PAY_METHOD.value = "account";
            f.action = "http://tpay.billgate.net/account/certify.jsp";
            $('#RETURN_URL').val('http://<?=$_SERVER['HTTP_HOST']?>/shop/billgate/return.php');
            //상용 URL 
            //f.action = "https://pay.billgate.net/account/certify.jsp";
            break;
        case "휴대폰":
            f.PAY_METHOD.value = "phone";
            f.action = "http://tpay.billgate.net/mobile/certify.jsp" ; //TEST
            $('#RETURN_URL').val('http://<?=$_SERVER['HTTP_HOST']?>/shop/billgate/return_phone.php');
            //f.action = "https://pay.billgate.net/mobile/certify.jsp" ; //REAL
            break;
        case "신용카드":
            f.PAY_METHOD.value = "card";
            f.action = "http://tpay.billgate.net/credit/certify.jsp";
            $('#RETURN_URL').val('http://<?=$_SERVER['HTTP_HOST']?>/shop/billgate/return.php');
    ...
    f.AMOUNT.value = tot_price;
    f.USER_NAME.value = f.od_name.value;
    //f.ITEM_NAME.value = encodeURIComponent('테스트');
    if(f.PAY_METHOD.value != "무통장") {

        var param = "od_id="+f.ORDER_ID.value+"&amount="+tot_price;
        var check_sum = "";
        $.ajax({
            type: "POST",
            data: param,
