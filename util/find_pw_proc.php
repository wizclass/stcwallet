...
$mb_name = isset($_POST['mb_name']) ? $_POST['mb_name'] : false;
$auth_number = isset($_POST['auth_number']) ? $_POST['auth_number'] : false;

if(!$type || !$mb_id || !$mb_name || !$auth_number){
    echo json_encode(array("code"=>$code,"msg"=>$msg));
    return false;
}

$where = "where mb_id = '{$mb_id}' and mb_name = '{$mb_name}' and mail_invalid = '{$auth_number}'";
