...
$check_email_sql = "select count(mb_id) as cnt from {$g5['member_table']} where mb_id = '{$to_email}'";
$check = sql_fetch($check_email_sql)['cnt'];

if($check > 0){
    echo json_encode(array("code"=>"300","msg"=>"이미 사용중인 이메일 입니다."));
    return false;
}
